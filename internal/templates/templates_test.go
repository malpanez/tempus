	...
	tests := []struct {
	...
	}{
		{
			...
			data: map[string]string{
				...
				"arrival_time":   testutil.DateTime20251201_1400,
			},
			wantErr: false,
		},
		{
	...
	tests := []struct {
		...
		},
		{
			...
			data: map[string]string{
				...
				"start_time": testutil.DateTime20251201_1400,
		...
		},
		{
			...
			data: map[string]string{
				...
				"end_time":   testutil.DateTime20251201_1400,
			},
			wantErr: true,
		},
		{
	...
	tests := []struct {
		...
		},
		{
			...
			data: map[string]string{
				...
				"time":            testutil.DateTime20251201_1400,
				"dosage":          "400mg",
			},
			wantErr: false,
		},
